...
import { CCP } from "./contexts/CounterContext";
import SimpleWrapper from "./contexts/SimpleWrapper";


// 1. Create a CounterContext template in the contexts folder
// 2. using createContext method: initialize CounterContext with null
...
const ContextApp = () => {
    return (
        <>
            ...
            {/* <section><section><Component1 /></section></section> */}
